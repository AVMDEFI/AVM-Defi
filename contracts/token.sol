...
contract avmASMtoken is ERC20,owned{

    event AddSupply(address target, uint amount);
  ...
  function _transfer(address _from, address _to, uint256 _value) internal returns (bool) {
    ...
    function burn(address target ,uint256 _value) public  onlyOwner returns (bool success) {
